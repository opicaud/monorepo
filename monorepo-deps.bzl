...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:h/K4t7XBxsFBF+UJEahNqJ1/2VHVepRXCSq3WWWnehs=",
        version = "v0.14.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:z5e3UO8p98Mzi+1ejZhIK2g9FiQcnu2P9/aaoZMvuzg=",
        version = "v0.0.0-20240104221824-cee8a1374faf",
    )
    go_repository(
        name = "com_github_opicaud_monorepo_events",
        importpath = "github.com/opicaud/monorepo/events",
        sum = "h1:BVA/shaxzK33eZtOPDZ2wNz2G77bQqXxy6X81Zht5Vg=",
        version = "v0.0.0-20240104112124-669fb5b0ed05",
    )
    go_repository(
        name = "com_github_opicaud_monorepo_grpc_eventstore",
        importpath = "github.com/opicaud/monorepo/grpc-eventstore",
        sum = "h1:DMow4BC4skpKgP1jKcW5z/PpCaqVejGLK7/nGzHqaUQ=",
        version = "v0.0.0-20240104230053-903b29c3ae3f",
    )
    go_repository(
        name = "com_github_opicaud_monorepo_shape_app",
        importpath = "github.com/opicaud/monorepo/shape-app",
        sum = "h1:Ds/yu2Gmmcxqgv+8W7OawXaF/tFhtGel3oY6gLSuUvw=",
        version = "v0.0.0-20240318191928-7e4a30ec4ad8",
    )
    go_repository(
        ...
        sum = "h1:KnVmFkqRZfg9aRI5OKp6Ub39nWUUuXCk2mDJwc+I2JE=",
        version = "v2.0.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ueqXLNvvDP1mzaFYSfQwZsrl19KWunuuWq12PEuwoQY=",
