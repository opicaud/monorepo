...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:gKgEiyJ8CPnr4r6pS06WfNXvp6z34JER1pBIwuocvVA=",
        version = "v1.49.8",
    )
    ...
    go_repository(
        ...
        sum = "h1:bN2+Fw9XPFvOCjB0UOevFIMICZ7G2XSQHzfvLUyOM5E=",
        version = "v1.7.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:XYAE1Ax5PMnDxA+uTy8AbbmSyUUUptClFud+NkxraDU=",
        version = "v0.0.0-20230628161154-c84f40480fe6",
    )
