...
func (c *eventStoreClient) Save(ctx context.Context, in *Events, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/evenstore.EventStore/Save", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventStoreClient) Load(ctx context.Context, in *UUID, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/evenstore.EventStore/Load", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EventStore_Save_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/evenstore.EventStore/Save",
	}
...
func _EventStore_Load_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/evenstore.EventStore/Load",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var EventStore_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc_event_store.proto",
}
