...
def go_dependencies():
    ...
    go_repository(
        ...
        patches = ["//shape-app/api/pacts:pact_ffi.patch"], #keep
        sum = "h1:goHw4h8JoZvn6rMJZWhJkEJPGXCGrWMgEGc6BDvVBHc=",
        version = "v2.0.0-beta.15.0.20221115234400-6010e689439b",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3+/0TAm9JD/PyhkrDWQWi2L197h3euCsM+H+J4iYTR8=",
        version = "v0.101.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:a1g7i05I2vUwq5eYrmxBJy6rPbw/yo7WzzwPJmcC0P4=",
        version = "v0.0.0-20220524023933-508584e28198",
    )
    go_repository(
